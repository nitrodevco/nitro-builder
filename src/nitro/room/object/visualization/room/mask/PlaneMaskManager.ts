import { Matrix, Point, RenderSurface, Sprite } from 'pixi.js';
import { IAssetPlaneMaskData, IAssetPlaneTextureBitmap, IGraphicAssetCollection, IVector3D, TextureUtils } from '../../../../../../api';
...
export class PlaneMaskManager
{
    ...
    public updateMask(renderer: RenderSurface, type: string, scale: number, normal: IVector3D, posX: number, posY: number): boolean
    {
        ...
        TextureUtils.writeToTexture(new Sprite(texture), renderer, false, matrix);

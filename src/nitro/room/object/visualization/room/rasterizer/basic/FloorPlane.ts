...
export class FloorPlane extends Plane
{
    ...
    public render(planeId: string, container: Container, width: number, height: number, scale: number, normal: IVector3D, useTexture: boolean, offsetX: number, offsetY: number): void
    {

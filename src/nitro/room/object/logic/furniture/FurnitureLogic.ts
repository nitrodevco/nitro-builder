import { IAssetData, IRoomGeometry, IRoomObjectController, IRoomObjectModel, IVector3D, MouseEventType, RoomObjectVariable, Vector3d } from '../../../../../api';
...
export class FurnitureLogic extends MovingObjectLogic
{
    ...
    constructor()
    {
        ...
        {
            FurnitureLogic.BOUNCING_STEPS = window.NitroBuilderConfig['furni.rotation.bounce.steps'];
        }

        if(FurnitureLogic.BOUNCING_Z === -1)
        {
            FurnitureLogic.BOUNCING_Z = window.NitroBuilderConfig['furni.rotation.bounce.height'];
        }
    }

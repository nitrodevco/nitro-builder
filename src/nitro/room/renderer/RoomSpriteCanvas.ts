...
import { GetTicker, IRoomCanvasMouseListener, IRoomGeometry, IRoomObject, IRoomObjectSprite, IRoomObjectSpriteVisualization, IRoomRenderingCanvas, IRoomSpriteCanvasContainer, IRoomSpriteMouseEvent, MouseEventType, RoomObjectSpriteData, RoomObjectSpriteType, Vector3d } from '../../../api';
...
export class RoomSpriteCanvas implements IRoomRenderingCanvas
{
    ...
    constructor(container: IRoomSpriteCanvasContainer, id: number, width: number, height: number, scale: number)
    {
        ...
        this._animationFPS = window.NitroBuilderConfig['system.fps.animation'];
